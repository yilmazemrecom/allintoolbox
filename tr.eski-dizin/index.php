        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 text-center mt-4 mt-lg-0">
                <div class="hero-visual" style="background: rgba(255,255,255,0.1); border: 2px solid rgba(255,255,255,0.2); border-radius: 20px; padding: 3rem 2rem; backdrop-filter: blur(10px);">
                    ...
                    <h4 class="text-white mb-2">10+ Ücretsiz Araç</h4>
                    <p class="text-white-50 mb-0">Hızlı • Güvenli • Kolay</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container my-5" id="tools">
    ...
    <div class="row g-4">
        ...
        foreach (TOOL_CATEGORIES as $categoryId => $categoryNames):
            $categoryTools = getToolsByCategory($categoryId, 'tr');
                ...
                <div class="card category-card h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h4 class="card-title mb-0"><?php echo $categoryNames['tr']; ?></h4>
                        </div>
                        ...
                        <a href="/tr/category/<?php echo $categoryId; ?>.php" class="btn btn-outline-<?php echo $iconInfo['color']; ?> btn-sm mt-3 w-100">
...
<section class="mb-5">
    <div class="container">
        <h2 class="text-center mb-5">
            <i class="fas fa-clock text-info"></i> <?php echo __('recently_added'); ?>
        </h2>
        <div class="row">
            <?php
            ...
            ?>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card recent-tool-card">
                        <div class="card-body text-center">
                            <span class="badge bg-success mb-2">Yeni</span>
                            ...
                            <a href="<?php echo $toolInfo['url']; ?>" class="btn btn-outline-primary btn-sm">
                                <i class="fas fa-external-link-alt"></i> <?php echo __('try_tool'); ?>
                            </a>
                        </div>
                    </div>
                </div>
