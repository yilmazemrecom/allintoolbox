...
<main class="main-content">
    <div class="container">
        ...
        $breadcrumbItems = [
            ...
            ['title' => __('category_finance'), 'url' => function_exists('getCategoryCleanUrl') ? getCategoryCleanUrl('finance', $currentLang) : '/pages/category.php?category=finance&lang=' . $currentLang],
            ['title' => __('currency_title')]
        ];
