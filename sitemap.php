...
function generateSitemapIndex($baseUrl) {
    ...
    echo '<!-- Generated by AllInToolbox SEO Sitemap Generator -->' . "\n";
    echo '<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">' . "\n";
    
    foreach (SUPPORTED_LANGUAGES as $lang) {
        // Her dil için sitemap entry
        echo "  <sitemap>\n";
    ...
    // Ana sitemap dosyası için de entry ekle
    echo "  <sitemap>\n";
    echo "    <loc>" . htmlspecialchars($baseUrl . '/sitemap.xml', ENT_XML1) . "</loc>\n";
    echo "    <lastmod>" . date('Y-m-d\TH:i:s\Z', $currentTime) . "</lastmod>\n";
    echo "  </sitemap>\n";
...
function getSitemapCacheKey($type, $lang = null) {
    return 'sitemap_' . $type . ($lang ? '_' . $lang : '') . '_v2';
}
...
function generateRobotsTxtSitemapReference() {
    ...
    foreach (SUPPORTED_LANGUAGES as $lang) {
        echo "Sitemap: {$baseUrl}/sitemap.php?type={$lang}\n";
    }
}
?>