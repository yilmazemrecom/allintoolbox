<?php
// pages/home.php - Unified Homepage (Mevcut yapıya göre düzeltildi)
session_start();
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="card category-card h-100">
                            <div class="card-body">
                                ...
                                <a href="/<?php echo $currentLang; ?>/<?php echo ($currentLang === 'tr') ? 'kategori' : 'category'; ?>/<?php echo $categoryId; ?>" class="btn btn-outline-<?php echo $iconInfo['color']; ?> btn-sm mt-3 w-100">
